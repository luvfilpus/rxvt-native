 ...
 * File:	xdefaults.c
 *----------------------------------------------------------------------*
 * $Id: xdefaults.c,v 1.113 2004/01/30 00:19:20 gcw Exp $
 *
...
/* command-line option = resource name */
    ...
    STRG(Rs_changeDirectory, NULL, "cd", "directory", "change directory"),
    BOOL(Rs_swapButtons, "swapButtons", "bs", Opt_swapButtons, "swap middle and right buttons"),
    BOOL(Rs_unixAltSpace, "unixAltSpace", "uas", Opt_unixAltSpace,
         "in win32 native mode, allow application to handle Alt-Space key sequence"),
